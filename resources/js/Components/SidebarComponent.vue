...
<div class="nk-sidebar-brand pt-3">
<a href="html/index.html" class="logo-link nk-sidebar-logo">
<h4 style="margin:0;padding:0;font-size:20px;font-weight:bold;color:#6F4E37;font-family:
  Inter, 'Helvetica Neue', Helvetica, 'PingFang SC', 'Hiragino Sans GB',
  'Microsoft YaHei', '微软雅黑', Arial, sans-serif;">Bean Origin</h4>
<p style="font-size:14px;font-weight: normal;color:#6F4E37;margin:0;padding:0;">
From farm to cup, transparently
</p>
</a>
</div>
...
<span class="nk-menu-text">Loan Management Panel</span><span class="nk-menu-badge">HOT</span>
</a>
</li><!-- .nk-menu-item -->
<li class="nk-menu-item">
