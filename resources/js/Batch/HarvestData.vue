  ...
  <div class="card-inner m-0 p-0">
    <div class="prompt-plain">
      <div class="prompt-head">
        ...
        <el-button v-if="isOwner" type="primary" :icon="Plus" @click="openModal">
          Add Records
        </el-button>
      </div>
    </div>
      ...
      <table class="table table-sm table-middle mb-0 linked-table">
        <thead>
          <tr>
            ...
            <th v-if="isOwner" class="text-right"><span class="head-label"><em class="icon ni ni-trash"></em></span></th>
          </tr>
        </thead>
        <tbody>
