...
const tabs = ref([
  { title: 'Open Orders', subtitle: 'Orders in progress', stats: 12, icon: 'ni-cart' },
  { title: 'Total Spend', subtitle: 'Current month spend', stats: 'UGX 15,420,000', icon: 'ni-coins' },
  { title: 'Watchlist', subtitle: 'Tracked market lots', stats: 4, icon: 'ni-eye' },
  { title: 'Suppliers', subtitle: 'Active sellers', stats: 4, icon: 'ni-users' },
]);
