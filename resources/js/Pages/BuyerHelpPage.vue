...
const form = useForm({
  ...
  contact_name: `${user?.fname ?? ''} ${user?.lname ?? ''}`.trim(),
  contact_email: user?.email ?? '',
  contact_phone: page.props?.response?.contact_phone ?? '',
});
...
const submitHelpRequest = () => {
  form.post(route('buyer.help.store'), {
    onSuccess: () => {
      ElMessage({
              ...
              <form class="row g-3" @submit.prevent="submitHelpRequest">
                ...
                <div class="col-12">
                  ...
                  <textarea
                    ...
                    class="form-control"
                    rows="6"
                    placeholder="Describe the issue, when it started, affected areas, and what you already tried."
                  ></textarea>
                ...
                <div class="col-12 col-md-4">
                  ...
                  <InputError :message="form.errors.preferred_channel" class="mt-2" />
                </div>
                ...
                <div class="col-12 col-md-4">
                  ...
                  <input v-model="form.contact_email" type="email" class="form-control" placeholder="you@example.com" />
                ...
                <div class="col-5">
                  <SubmitButton :title="'Submit Help Request'" :status="form.processing" />
                </div>
              </form>
            </div>
          </div>
