...
const submitHelpRequest = () => {
  ...
  // TODO: connect to backend endpoint for help requests
  setTimeout(() => {
    ...
    <div class="col-12 col-xl-8">
      <div class="card card-bordered">
        <div class="card-inner border-bottom">
          ...
          <p class="sub-text mb-0">Describe your issue so the right admin/stakeholder team can respond quickly.</p>
        </div>
        ...
        <div class="card-inner">
          <form class="row g-3" @submit.prevent="submitHelpRequest">
            ...
            <div class="col-12 col-md-6 d-flex align-items-end">
              <submit-button :title="'Submit Help Request'" :status="isSubmitting" />
            </div>
          </form>
        </div>
      </div>
