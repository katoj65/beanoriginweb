...
<a href="#" class="header-tool-btn text-reset" title="Home" aria-label="Go to home">
<em class="icon ni ni-home-fill header-tool-icon"></em>
</a>
<a href="#" class="header-tool-btn text-reset" title="Search" aria-label="Open search">
<em class="icon ni ni-search header-tool-icon"></em>
</a>
<a href="#" class="header-tool-btn text-reset" title="Notifications" aria-label="View notifications">
<em class="icon ni ni-bell-fill header-tool-icon"></em>
</a>
...
<em class="icon ni ni-user-fill header-tool-icon"></em>
...
<li class="nk-menu-item">
<a href="html/components/widgets/ratings.html" class="nk-menu-link"><span class="nk-menu-text">Ratings Widget</span></a>
</li><!-- .nk-menu-item -->
</ul><!-- .nk-menu-sub -->
</li><!-- .nk-menu-item -->
<li class="nk-menu-item has-sub">
